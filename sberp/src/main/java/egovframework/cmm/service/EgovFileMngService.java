...
public interface EgovFileMngService {
  ...
  public String insertFileInfs(List<FileVO> fileResults, String insMemId) throws Exception;
  ...
  public void updateFileInfs(List<FileVO> fvoList, String insMemId) throws Exception;
  ...
  /**
   * 파일이름으로 erp에서 올린 파일과, upload api에서 올린 파일을 구분한다.
   * 
   * @param fileNm
   * @return
   */
