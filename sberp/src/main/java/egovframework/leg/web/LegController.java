...
public class LegController {
  ...
  public ModelAndView excel(@ModelAttribute ComParam param, HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    String[] columnVarArr = {"no", "sbkId", "rcptDt", "carryInDate","carryInName","testDtStr","testId","cmpyName","prdctName","modelName","testStndr","inCnt","outCnt","carryOutDate","carryOutName","carryOutType","carryOutDlvryName","carryOutDlvryInvc","reportDt"};
