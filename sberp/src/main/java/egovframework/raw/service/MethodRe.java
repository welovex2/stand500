...
public class MethodRe {
  ...
  @ApiModelProperty(value = "대역3_시험전압10M_YN ", example = "")
  @Column
  private int hz3Vlt10mYn;

  
  @ApiModelProperty(value = "대역3_시험전압_ETC1 ", example = "")
  @Column
  private int hz3VltEtc1Yn;

  
  @ApiModelProperty(value = "대역3_측정거리_3M ", example = "")
  @Column
  private int hz3Lngth3mYn;

  
  @ApiModelProperty(value = "대역3_온도 ", example = "")
  @Column
  private String hz3Temp;


  @ApiModelProperty(value = "대역3_온도 ", example = "")
  @Column
  private String hz3TempPlus;


  @ApiModelProperty(value = "대역3_습도 ", example = "")
  @Column
  private String hz3Hmdt;


  @ApiModelProperty(value = "대역3_습도 ", example = "")
  @Column
  private String hz3HmdtPlus;


  @ApiModelProperty(value = "대역3_측정년 ", example = "")
  @Column
  private int hz3MsrmnYear;


  @ApiModelProperty(value = "대역3_측년월 ", example = "")
  @Column
  private int hz3MsrmnMon;


  @ApiModelProperty(value = "대역3_측정일 ", example = "")
  @Column
  private int hz3MsrmnDay;


  @ApiModelProperty(value = "대역3_측정시 ", example = "")
  @Column
  private int hz3MsrmnHour;


  @ApiModelProperty(value = "대역3_측정분 ", example = "")
  @Column
  private int hz3MsrmnMin;


  @ApiModelProperty(value = "대역3_서명 ", example = "")
  @Column
  private String hz3Sign;


  @ApiModelProperty(value = "대역3_서명_URL ", example = "")
  @Column
  private String hz3SignUrl;


  @ApiModelProperty(value = "대역3_시험결과_CODE ", example = "")
  @Column
