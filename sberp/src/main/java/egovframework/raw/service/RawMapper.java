...
public interface RawMapper {
  ...
  public void insertSpec(@Param("rawSeq") int rawSeq,
      @Param("rawSpecList") List<RawSpec> rawSpecList);

  public void updateSpec(@Param("rawSeq") int rawSeq,
      @Param("rawSpecList") List<RawSpec> rawSpecList);

  public void deleteSpec(@Param("rawSeq") int rawSeq,
      @Param("rawSpecList") List<RawSpec> rawSpecList);

  public void insertTchn(@Param("rawSeq") int rawSeq,
      @Param("rawTchnList") List<RawTchn> rawTchnList);

  public void updateTchn(@Param("rawSeq") int rawSeq,
      @Param("rawTchnList") List<RawTchn> rawTchnList);

  public void deleteTchn(@Param("rawSeq") int rawSeq,
      @Param("rawTchnList") List<RawTchn> rawTchnList);

  public void insertAsstn(@Param("rawSeq") int rawSeq,
      @Param("rawAsstnList") List<RawAsstn> rawAsstnList);

  public void updateAsstn(@Param("rawSeq") int rawSeq,
      @Param("rawAsstnList") List<RawAsstn> rawAsstnList);

  public void deleteAsstn(@Param("rawSeq") int rawSeq,
      @Param("rawAsstnList") List<RawAsstn> rawAsstnList);
  ...
  public void insertCable(@Param("rawSeq") int rawSeq,
      @Param("rawCableList") List<RawCable> rawCableList);

  public void updateCable(@Param("rawSeq") int rawSeq,
      @Param("rawCableList") List<RawCable> rawCableList);

  public void deleteCable(@Param("rawSeq") int rawSeq,
      @Param("rawCableList") List<RawCable> rawCableList);
  ...
  public void insertMethod(@Param("rawSeq") int rawSeq,
      @Param("methodList") List<RawMet> methodList);
