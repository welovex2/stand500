...
public class TestItemDTO extends TestItem {
  ...
  @ApiModelProperty(value = "인증종류(국가) ", example = "방송통신 기")
  @Column
  private String crtfc1Name;

  @ApiModelProperty(value = "인증종류1 ", example = "적합인증(방")
  @Column
  private String crtfc2Name;

  @ApiModelProperty(value = "인증종류2 ", example = "적합인증(방")
  @Column
  private String crtfc3Name;
  
  @ApiModelProperty(value = "인증종류3 ", example = "적합인증(방")
  @Column
  private String crtfc4Name;
  
  @ApiModelProperty(value = "시험규격 ", example = "603 (전기")
  @Column
  ...
  @ApiModelProperty(value = "로데이터여부 ", example = "미완료")
  @Column
  ...
  @ApiModelProperty(value = "시험신청자 부서 ", example = "")
  @Column
  private String testMemDept;
  
  @ApiModelProperty(value = "시험신청자 ", example = "")
  @Column
